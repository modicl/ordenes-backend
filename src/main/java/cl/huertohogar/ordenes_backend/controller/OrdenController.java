...
public class OrdenController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Lista de órdenes obtenida exitosamente",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = OrdenResponseDTO.class)))
    })
    @GetMapping
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Órdenes del usuario obtenidas exitosamente",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = OrdenResponseDTO.class))),
    ...
    public ResponseEntity<Orden> crearOrden(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos de la orden a crear", required = true,
    ...
    public ResponseEntity<Orden> actualizarOrden(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Datos actualizados de la orden", required = true,
                content = @Content(schema = @Schema(implementation = Orden.class)))
            @RequestBody Orden orden) {
